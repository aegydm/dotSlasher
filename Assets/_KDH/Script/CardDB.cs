...
public class CardDB : ScriptableObject
{
    ...
    private void ReadCharData(string v, List<Card> cards)
    {
        ...
        for (int i = 0; i < dicList.Count; i++)
        {
            ...
            //Debug.Log("Sprites/" + dicList[i]["faction"].ToString() + "/" + dicList[i]["faction"].ToString() + "_" + dicList[i]["type"].ToString() + "/" + dicList[i]["sprite"].ToString() + "/" + dicList[i]["sprite"].ToString());
            ...
            //card.animator = Resources.Load<Animator>("");
